/*   geometry.c                Version 1.6     */
/*   Last Modification : 12/6/94 19:20:58        */
/*-----------------------------------------------------------------*/
...
char *when)
{
    ...
    /* fixed a bug here.  If t is not initialized to 0, there is no
       way the done_tri macro will work properly!.  ZHS 12/6/94
    */
