/*   dev_solve.c                Version 1.6     */
/*   Last Modification : 7/21/94 15:44:52        */
/*-----------------------------------------------------------------*/
...
char *movie)
{
    ...
    bval_compute( 300.0, new_sol, 0.0 );
	...
	sk = dev_sol[k];
	for(i = 0; i < nn; i++) new_sol[sk][i] = nd[i]->sol[sk];
    }
...
double *rhs2)		/*the two norm of the right hand side*/
{
	...
	setup_2d(bs, cs.temp, cs.nsol, cs.sol, NULL, NULL, cs.nuevo, cs.newa, 
