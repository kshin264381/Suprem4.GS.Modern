/*   pearson.c                Version 1.5     */
/*   Last Modification : 7/21/94 15:57:36        */
/*-----------------------------------------------------------------*/
...
int secondary,	/*1 = calculate the damage profile, 2 = plusone profile*/
