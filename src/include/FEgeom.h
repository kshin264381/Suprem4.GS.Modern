...
struct FEnd_str {
    ...
    void *pflag;                /* Unspecified pointer flag, used now     */
                                /* to point to corresponding forest point */
    };
...
struct FEdesc_str 
{
 ...
 void (*stiff)( double *, double *, double *, double *,
	      void (*)(double *, int, double *, double *),int);
 void (*coeff)(double *, int, double *, double *);
 void (*bound)(double *, double *, double *, double *,
	      void (*)(double *, int, double *, double *), int, 
	      int *, double *, int, int);
 void (*nodal_stress)(double *, double *, double *, double *,
