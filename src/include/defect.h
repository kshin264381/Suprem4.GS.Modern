...
EXTERN double Kcpl[2][MAXMAT][MAXIMP][MAXCHG];
EXTERN double Kcpl0[2][MAXMAT][MAXIMP][MAXCHG];
EXTERN double KcplE[2][MAXMAT][MAXIMP][MAXCHG];
...
#define globalalpha(A,M) impur[A].constant[M][12][0]
#define damalpha(A,M)   impur[A].constant[M][13][0]
#define damcenter(A,M)  impur[A].constant[M][14][0]
#define damwidth(A,M)   impur[A].constant[M][15][0]
