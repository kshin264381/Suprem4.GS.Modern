...
struct imp_str {
    ...
    void (* coupling)(float, double *, double **, double **, double **, 
                      double **); /* impurity-impurity coupling  */

    void (* boundary)(struct bound_str *); /* set up boundary conditions     */

    void (* algebc)();               /* set up boundary conditions           */

    void (* active)(int, int, float, double **, double **, double **, 
                    double *);  /* active concentration calculator    */

    void (* time_val)(int, double *, struct call_str *);
                                     /* time term calculation function       */

    void (* block_set)(int, float, int, int *, double *, double **, double **,
                       double *, double *); /* block jacobian terms          */
};
...
//EXTERN struct bound_str *bval;
EXTERN bound_str *bval;
