/*   coeffox.c                Version 1.5     */
/*   Last Modification : 7/21/94 22:12:52        */
/*-----------------------------------------------------------------*/
    ...
    int *nfla)
{
    ...
    *nfla = 0;
    ...
    for(walk = strtok( input, (char *) sep); walk; walk = strtok( NULL, (char *) sep)) {
