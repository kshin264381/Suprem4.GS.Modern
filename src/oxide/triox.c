/*   triox.c                Version 1.5     */
/*   Last Modification : 7/24/94 12:45:41        */
/*-----------------------------------------------------------------*/
               ...
               shp[i][0/1] = x,y derivative of shp[i][2] */
{
    ...
    if (NEL==7) {
    if( s == 0.5 && t == 0.5 ) {
    *(shp + 3*(0) + (0)) =  0.75; *(shp + 3*(0) + (1)) =   0.75; *(shp + 3*(0) + (2)) =  0.0;
    *(shp + 3*(1) + (0)) =  0.75; *(shp + 3*(1) + (1)) =  -0.25; *(shp + 3*(1) + (2)) =  0.0; 
    *(shp + 3*(2) + (0)) = -0.25; *(shp + 3*(2) + (1)) =   0.75; *(shp + 3*(2) + (2)) =  0.0; 
    *(shp + 3*(3) + (0)) =   3.0; *(shp + 3*(3) + (1)) =    3.0; *(shp + 3*(3) + (2)) =  1.0; 
    *(shp + 3*(4) + (0)) =  -1.0; *(shp + 3*(4) + (1)) =   -1.0; *(shp + 3*(4) + (2)) =  0.0; 
    *(shp + 3*(5) + (0)) =  -1.0; *(shp + 3*(5) + (1)) =   -1.0; *(shp + 3*(5) + (2)) =  0.0; 
    *(shp + 3*(6) + (0)) = -2.25; *(shp + 3*(6) + (1)) =  -2.25; *(shp + 3*(6) + (2)) =  0.0;
    }
    else if( s == 0 && t == 0.5) {
    *(shp + 3*(0) + (0)) = -0.75; *(shp + 3*(0) + (1)) = -1.0; *(shp + 3*(0) + (2)) =  0.0; 
    *(shp + 3*(1) + (0)) = -0.75; *(shp + 3*(1) + (1)) =  0.0; *(shp + 3*(1) + (2)) =  0.0; 
    *(shp + 3*(2) + (0)) =  0.25; *(shp + 3*(2) + (1)) =  1.0; *(shp + 3*(2) + (2)) =  0.0; 
    *(shp + 3*(3) + (0)) =   1.0; *(shp + 3*(3) + (1)) =  0.0; *(shp + 3*(3) + (2)) =  0.0; 
    *(shp + 3*(4) + (0)) =  -3.0; *(shp + 3*(4) + (1)) =  0.0; *(shp + 3*(4) + (2)) =  1.0; 
    *(shp + 3*(5) + (0)) =   1.0; *(shp + 3*(5) + (1)) =  0.0; *(shp + 3*(5) + (2)) =  0.0; 
    *(shp + 3*(6) + (0)) =  2.25; *(shp + 3*(6) + (1)) =  0.0; *(shp + 3*(6) + (2)) =  0.0; 
    }
    else if (s == 0.5 && t == 0) {
    *(shp + 3*(0) + (0)) = -1.0; *(shp + 3*(0) + (1)) =  -0.75; *(shp + 3*(0) + (2)) =  0.0; 
    *(shp + 3*(1) + (0)) =  1.0; *(shp + 3*(1) + (1)) =   0.25; *(shp + 3*(1) + (2)) =  0.0; 
    *(shp + 3*(2) + (0)) =  0.0; *(shp + 3*(2) + (1)) =  -0.75; *(shp + 3*(2) + (2)) =  0.0; 
    *(shp + 3*(3) + (0)) =  0.0; *(shp + 3*(3) + (1)) =    1.0; *(shp + 3*(3) + (2)) =  0.0; 
    *(shp + 3*(4) + (0)) =  0.0; *(shp + 3*(4) + (1)) =    1.0; *(shp + 3*(4) + (2)) =  0.0; 
    *(shp + 3*(5) + (0)) =  0.0; *(shp + 3*(5) + (1)) =   -3.0; *(shp + 3*(5) + (2)) =  1.0; 
    *(shp + 3*(6) + (0)) =  0.0; *(shp + 3*(6) + (1)) =   2.25; *(shp + 3*(6) + (2)) =  0.0;
    }
    }
    else {
    ...
    *(shp + 3*(5) + (1)) = -4 * s;
    ...
    if( NEL==7) {
        /* The bubble node */
        *(shp + 3*(6) + (2)) = 27*lam0*lam1*lam2;
        *(shp + 3*(6) + (0)) = 27*lam2*(lam0-lam1);
        *(shp + 3*(6) + (1)) = 27*lam1*(lam0-lam2);

        /* Force other shape functions to zero here */
        for (j = 0; j < 3; j++) {
        double dj = - *(shp + 3*(6) + (j))/9;
        *(shp + 3*(0) + (j)) -= dj;
        *(shp + 3*(1) + (j)) -= dj;
        *(shp + 3*(2) + (j)) -= dj;
        dj *= -4;
    ...
    for (k = 0; k < NEL; k++) {
    xs00 += cord[k][0] * *(shp + 3*(k) + (0));
    xs01 += cord[k][1] * *(shp + 3*(k) + (0));
    xs10 += cord[k][0] * *(shp + 3*(k) + (1));
    xs11 += cord[k][1] * *(shp + 3*(k) + (1));
    }
    *xsj = xs00*xs11 - xs01*xs10;
    ...
    for (k=0; k < NEL; k++) {
    tmpx = *(shp + 3*(k) + (0))*sx00 + *(shp + 3*(k) + (1))*sx01;
    tmpy = *(shp + 3*(k) + (0))*sx10 + *(shp + 3*(k) + (1))*sx11;
    *(shp + 3*(k) + (0)) = tmpx;
    *(shp + 3*(k) + (1)) = tmpy;
    }
...
void obfix(double *Cord, double *cord)
{
    ...
    dcopy( Cord, cord, NEL*2);

    if( oxide_obfix >= 1) return;
    
    /* Test each angle for obtuseness */
    for( j = 0; j < 3; j++) {
	px = *(cord + 2*( (j+1)%3) + (X)) - *(cord + 2*( j) + (X));
	py = *(cord + 2*( (j+1)%3) + (Y)) - *(cord + 2*( j) + (Y));
	qx = *(cord + 2*( (j+2)%3) + (X)) - *(cord + 2*( j) + (X));
	qy = *(cord + 2*( (j+2)%3) + (Y)) - *(cord + 2*( j) + (Y));
	dot = px*qx + py*qy;
	if( dot < 0) {
    ...
    vy = *(cord + 2*( j) + (Y)) - cy;
    v  = sqrt( vx*vx+vy*vy);
    *(cord + 2*( j) + (X)) = cx + r*vx/v;
    *(cord + 2*( j) + (Y)) = cy + r*vy/v;

    /* Set the remaining points accordingly */
    for ( j = 3; j < 6; j++) {
	*(cord + 2*( j) + (X)) = 0.5*(*(cord + 2*( (j+1)%3) + (X)) + *(cord + 2*( (j+2)%3) + (X)));
	*(cord + 2*( j) + (Y)) = 0.5*(*(cord + 2*( (j+1)%3) + (Y)) + *(cord + 2*( (j+2)%3) + (Y)));
    }
    if (NEL == 7) {
	*(cord + 2*( 6) + (X)) = (*(cord + 2*(0) + (X)) + *(cord + 2*(1) + (X)) + *(cord + 2*(2) + (X)))/3;
	*(cord + 2*( 6) + (Y)) = (*(cord + 2*(0) + (Y)) + *(cord + 2*(1) + (Y)) + *(cord + 2*(2) + (Y)))/3;
    }
}
...
void triox_stiff(
     ...
     int (*coeff)(double *, int, double *, double *),		/* Fetches material data */
     int mat)			/* What material this triangle is */
#endif
void triox_stiff(double *stiff,
		 double *wrhs,
		 double *xl,
		 double *disp,
		 ...
		 int mat)
{
	...
	/* The shape functions */
	triox_shape( sg[l], tg[l], xl, &xsj, &shp[0][0]);
	dv = wg*xsj;
	...
	for (j = 0; j < NEL; j++) {
	    ...
	    exx += sjx * *(disp + 3*( j) + (X));
	    eyy += sjy * *(disp + 3* j + Y);
	    exy += sjx * *(disp + 3* j + Y) + sjy * *(disp + 3*j + X);
	    fx  += sjx * *(disp + 3* j + D);
	    fy  += sjy * *(disp + 3* j + D);
	}
	...
	for (j = 0; j < NEL; j++) {
	    ...
	    /*compute rhs*/
	    *(wrhs + 3*( j) + ( X)) -= dv * (sxx*sjx + sxy*sjy);
	    *(wrhs + 3*( j) + ( Y)) -= dv * (sxy*sjx + syy*sjy);
	    *(wrhs + 3*( j) + ( D)) -= fr * (fx* sjx + fy* sjy);
		...
		six = shp[i][X];
		siy = shp[i][Y];
		*(stiff + (3*NEL)*( 3*i+X) + ( 3*j+X)) += six*db00 + siy*db20;
		*(stiff + (3*NEL)*( 3*i+X) + ( 3*j+Y)) += six*db01 + siy*db21;
		*(stiff + (3*NEL)*( 3*i+Y) + ( 3*j+X)) += six*db20 + siy*db10;
		*(stiff + (3*NEL)*( 3*i+Y) + ( 3*j+Y)) += six*db21 + siy*db11;
		*(stiff + (3*NEL)*( 3*j+D) + ( 3*i+X)) += ddd*(fxx*six + fxy*siy);
		*(stiff + (3*NEL)*( 3*j+D) + ( 3*i+Y)) += ddd*(fxy*six + fyy*siy);
		*(stiff + (3*NEL)*( 3*j+D) + ( 3*i+D)) += six*ddx  + siy*ddy;
	    }
	}
    }
}
     ...
     int fixme)		
{
	...
	for( j = 0; j < 3; j++) {
		...
		for( k = 1; k<= 2; k++) {
		    l = (j+k)%3;
		    m=j+3;
		    dx = *(xl + 2*( l) + (0)) - *(xl + 2*( m) + (0));
		    dy = *(xl + 2*( l) + (1)) - *(xl + 2*( m) + (1));
		    if( *(fixity + 3*( l) + ( X)) != 1) *(wrhs + 3*( l) + ( X)) -= STgamma*( dx);
		    if( *(fixity + 3*( l) + ( Y)) != 1) *(wrhs + 3*( l) + ( Y)) -= STgamma*( dy);
		    if( *(fixity + 3*( m) + ( X)) != 1) *(wrhs + 3*( m) + ( X)) += STgamma*( dx);
		    if( *(fixity + 3*( m) + ( Y)) != 1) *(wrhs + 3*( m) + ( Y)) += STgamma*( dy);
		}
	    }
	}
    }
    ...
    for( l = 0; l < NEL; l++) {
        if( *(fixity + 3*( l) + (X)) != 4 && *(fixity + 3*( l) + (Y)) != 4) continue;
	IsItf++;
	*(wrhs + 3*( l) + (X)) = 0;
	*(wrhs + 3*( l) + (Y)) = 0;

	for (m = 0; m < 3*NEL; m++) {
	    *(stiff + (3*NEL)*( 3*l+X) + ( m)) = 0;
	    *(stiff + (3*NEL)*( 3*l+Y) + ( m)) = 0;
	}
    }
    ...
    if (!noderiv)
    for (l = 0; l < 3; l++) {
	triox_shape( locg[l][0], locg[l][1], xl, &xsj, &shpg[l][0][0]);
    }
	...
	*(wrhs + 3*( l) + ( X)) = -(*(disp + 3*(l) + (X)) - ksv * n[X] * *(disp + 3*(l) + (D)) - toc * n[X]);
	*(wrhs + 3*( l) + ( Y)) = -(*(disp + 3*(l) + (Y)) - ksv * n[Y] * *(disp + 3*(l) + (D)) - toc * n[Y]);
	if (noderiv) continue;
	*(stiff + (3*NEL)*( 3*l+X) + ( 3*l+X)) = 1;
	*(stiff + (3*NEL)*( 3*l+Y) + ( 3*l+Y)) = 1;
	*(stiff + (3*NEL)*( 3*l+X) + ( 3*l+D)) =     - ksv * n[X];
	*(stiff + (3*NEL)*( 3*l+Y) + ( 3*l+D)) =     - ksv * n[Y];
	...
	for (m = 0; m < NEL; m++) {
	    ...
	    *(stiff + (3*NEL)*( 3*l+X) + ( 3*m+X)) += -vcv * n[X] * dkdu * *(disp + 3*(l) + (D));
	    *(stiff + (3*NEL)*( 3*l+X) + ( 3*m+Y)) += -vcv * n[X] * dkdv * *(disp + 3*(l) + (D));
	    *(stiff + (3*NEL)*( 3*l+Y) + ( 3*m+X)) += -vcv * n[Y] * dkdu * *(disp + 3*(l) + (D));
	    *(stiff + (3*NEL)*( 3*l+Y) + ( 3*m+Y)) += -vcv * n[Y] * dkdv * *(disp + 3*(l) + (D));
	    *(stiff + (3*NEL)*( 3*l+D) + ( 3*m+X)) +=  FEnd[ in]->garbage[RI] * dkdu;
	    *(stiff + (3*NEL)*( 3*l+D) + ( 3*m+Y)) +=  FEnd[ in]->garbage[RI] * dkdv;
	}
	}
    }
	...
	if (nbr >= 0 && FEelt[ nbr]->mat == Si) {
	    ...
	    nx = *(xl + 2*((j+1)%3) + (1)) - *(xl + 2*((j+2)%3) + (1));
	    ny = *(xl + 2*((j+2)%3) + (0)) - *(xl + 2*((j+1)%3) + (0));
	    len = hypot( nx, ny);
		...
		*(stiff + (3*NEL)*( 3*l+D) + ( 3*l+D)) += cpl;
		*(wrhs  + 3*( l) + ( D))         -= cpl * *(disp + 3*( l) + ( D));
	    }
	}
    }
}
		  ...
		  double *xsj)
{
    ...
    triox_shape( where[0], where[1], xl, xsj, &shp[0][0]);
    for (j=0; j < NEL; j++) {
	eps[ XX] += shp[j][X] * *(ul + 3*(j) + (X));
	eps[ YY] += shp[j][Y] * *(ul + 3*(j) + (Y));
	eps[ XY] += shp[j][X] * *(ul + 3*(j) + (Y)) + shp[j][Y] * *(ul + 3*(j) + (X));
    }
     ...
     int fixme)			/* a variable of unsurpassed ugliness */
{
	...
	if( nbr >= 0 && FEelt[ nbr]->mat == SiO2) {
		...
		*(wrhs + 2*l + X) += simpson[ k] * len * tx;
		*(wrhs + 2*l + Y) += simpson[ k] * len * ty;
	    }
	}
    }
}
