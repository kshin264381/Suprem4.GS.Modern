...
/* Remove __noplot__ definition from global.h if you wish to debug X11 */
#ifdef __noplot__
void plot_2d(char *par, par_str* param)
{
    fprintf(stdout, "Whoops!! plot.2d doesn't work at this moment!!\n");
}
...
par_str* param)
{
    ...
    /* 
     *  If we are use an external grid code, then we have
     *  to get a copy of the grid in order to plot...
     */
