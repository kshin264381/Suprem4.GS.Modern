...
// Original
//#define YYRETURN(A) { free((char *)yys); free((char *)yyv); return(A); }
// Makeshift 1
#define YYRETURN(A) { return A; }
// Makeshift 2
//#define YYRETURN(A) { free(yyss); free(yyvs); return A; }


#line 128 "shell/parser.c" /* yacc.c:339  */
...
union YYSTYPE
{
#line 67 "shell/parser.y" /* yacc.c:355  */

    int ival;
    char *sval;
    

#line 224 "shell/parser.c" /* yacc.c:355  */
};
...
#line 241 "shell/parser.c" /* yacc.c:358  */
...
{
       0,    84,    84,   107,   126,   154,   173,   192,   237,   294,
     327,   334,   346,   358,   383,   389,   395,   401,   411,   412,
     416,   418,   420,   422,   427,   432,   437,   443,   448,   457,
     479
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 85 "shell/parser.y" /* yacc.c:1646  */
    {
	    ...
	    free((char *)cmd);
	    if (par != NULL) free((char *)par);
	    if (red != NULL) free((char *)red);

	    if (depth == -1) YYRETURN( back & PROMPT );
	}
#line 1388 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 3:
#line 108 "shell/parser.y" /* yacc.c:1646  */
    {
...
#line 1411 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 4:
#line 127 "shell/parser.y" /* yacc.c:1646  */
    {
	    char *par = (yyvsp[-2].sval), *red = (yyvsp[-1].sval);
	    int back = (yyvsp[0].ival);
...
#line 1443 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 5:
#line 155 "shell/parser.y" /* yacc.c:1646  */
    {
...
#line 1466 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 6:
#line 174 "shell/parser.y" /* yacc.c:1646  */
    {
	    char *par = (yyvsp[-1].sval);
	    int back = (yyvsp[0].ival);
...
#line 1489 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 7:
#line 193 "shell/parser.y" /* yacc.c:1646  */
    {
	    char *par = (yyvsp[-2].sval), *red = (yyvsp[-1].sval);
	    int back = (yyvsp[0].ival);
	    char str[160];
	    ...
	    if (depth == -1) YYRETURN( PROMPT );
	}
#line 1538 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 8:
#line 238 "shell/parser.y" /* yacc.c:1646  */
    {
	    char *body;
	    char *list;
	    char *name;
	    ...
	    if ( depth == -1 ) {
    		...
    		if (body != NULL) free((char *)body);
    		if (list != NULL) free((char *)list);
    		if (name != NULL) free((char *)name);
    		if (rdir != NULL) free((char *)rdir);
...
#line 1599 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 9:
#line 295 "shell/parser.y" /* yacc.c:1646  */
    {
...
#line 1636 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 10:
#line 328 "shell/parser.y" /* yacc.c:1646  */
    {
	    int back = (yyvsp[0].ival);
	    do_echo();
...
#line 1647 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 11:
#line 335 "shell/parser.y" /* yacc.c:1646  */
    {
	    char *par = (yyvsp[-1].sval);
	    int back = (yyvsp[0].ival);
	    do_echo();
	    ...
	    /*do no take the action if storing*/
	    if (depth == -1) do_set(par, TRUE);
	    /*free up the wasted space*/
	    if (par != NULL) free((char *)par);
	    if (depth == -1) YYRETURN( back & PROMPT );
	}
#line 1663 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 12:
#line 347 "shell/parser.y" /* yacc.c:1646  */
    {
	    char *par = (yyvsp[-1].sval);
	    int back = (yyvsp[0].ival);
	    do_echo();
	    ...
	    /*do no take the action if storing*/
	    if (depth == -1) do_set(par, FALSE);
	    /*free up the wasted space*/
	    if (par != NULL) free((char *)par);
	    if (depth == -1) YYRETURN( back & PROMPT );
	}
#line 1679 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 13:
#line 359 "shell/parser.y" /* yacc.c:1646  */
    {
	    char *par = (yyvsp[-1].sval);
	    int back = (yyvsp[0].ival);
	    char *s;
...
#line 1708 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 14:
#line 384 "shell/parser.y" /* yacc.c:1646  */
    {
	    echo_bufptr = 0;

	    if (depth == -1) YYRETURN( (yyvsp[0].ival) );
	}
#line 1718 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 15:
#line 390 "shell/parser.y" /* yacc.c:1646  */
    {
	    echo_bufptr = 0;

	    if (depth == -1) YYRETURN(-1);
	}
#line 1728 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 16:
#line 396 "shell/parser.y" /* yacc.c:1646  */
    {
	    do_echo();

	    if (depth == -1) YYRETURN(-1);
	}
#line 1738 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 17:
#line 402 "shell/parser.y" /* yacc.c:1646  */
    {
	    do_echo();

	    fprintf(stderr, "illegal input\n");
	    if (depth == -1) YYRETURN( (yyvsp[0].ival) & PROMPT );
	}
#line 1749 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 20:
#line 417 "shell/parser.y" /* yacc.c:1646  */
    {  (yyval.ival) = ~BACKGROUND & PROMPT; }
#line 1755 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 21:
#line 419 "shell/parser.y" /* yacc.c:1646  */
    {  (yyval.ival) = BACKGROUND | PROMPT; }
#line 1761 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 22:
#line 421 "shell/parser.y" /* yacc.c:1646  */
    {  (yyval.ival) = 0; }
#line 1767 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 23:
#line 423 "shell/parser.y" /* yacc.c:1646  */
    {  (yyval.ival) = BACKGROUND; }
#line 1773 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 24:
#line 428 "shell/parser.y" /* yacc.c:1646  */
    {
	    fprintf(stderr, "no file for redirection!\n");
	    (yyval.sval) = NULL;
	}
#line 1782 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 25:
#line 433 "shell/parser.y" /* yacc.c:1646  */
    {
	    (yyval.sval) = (yyvsp[0].sval);
	}
#line 1790 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 26:
#line 437 "shell/parser.y" /* yacc.c:1646  */
    {
	    (yyval.sval) = NULL;
	}
#line 1798 "shell/parser.c" /* yacc.c:1646  */
    break;
...
#line 1806 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 28:
#line 448 "shell/parser.y" /* yacc.c:1646  */
    {
	    (yyval.sval) = NULL;
	}
#line 1814 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 29:
#line 457 "shell/parser.y" /* yacc.c:1646  */
    {
...
#line 1836 "shell/parser.c" /* yacc.c:1646  */
    break;

  case 30:
#line 479 "shell/parser.y" /* yacc.c:1646  */
    {
	    char *s;
...
#line 1851 "shell/parser.c" /* yacc.c:1646  */
    break;


#line 1855 "shell/parser.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 492 "shell/parser.y" /* yacc.c:1906  */
