#ifndef __DATAREC_H__
#define __DATAREC_H__
...
#ifdef __cplusplus
    void (*xg_text)(Widget, int, int, char*, int, int);		/* Draws text at a location              */
    void (*xg_seg)(Widget, int, XSegment*, int, int, int, int);		/* Draws a series of segments            */
    void (*xg_dot)(Widget, int, int, int, int, int);		/* Draws a dot or marker at a location   */
    void (*xg_end)(Widget);		/* Stops the drawing sequence            */
#else
