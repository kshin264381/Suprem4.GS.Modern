...
int idrawInit(FILE* strm, int width, int height, char* title_family, double title_size,
    char* axis_family, double axis_size, int flags, xgOut* out_info, Widget* userinfo, char* errmsg)
